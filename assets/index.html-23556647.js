import{_ as t,M as i,p as r,q as l,R as n,t as s,N as a,a1 as o}from"./framework-96b046e1.js";const c={},d=o('<h1 id="sonarqube-instalacao-inicial" tabindex="-1"><a class="header-anchor" href="#sonarqube-instalacao-inicial" aria-hidden="true">#</a> Sonarqube - Instalação inicial</h1><h2 id="instalacao-projeto" tabindex="-1"><a class="header-anchor" href="#instalacao-projeto" aria-hidden="true">#</a> Instalação projeto</h2><h3 id="requerimentos-tecnicos" tabindex="-1"><a class="header-anchor" href="#requerimentos-tecnicos" aria-hidden="true">#</a> Requerimentos técnicos</h3>',3),p={href:"https://www.docker.com/get-started",target:"_blank",rel:"noopener noreferrer"},u={href:"https://git-scm.com/downloads",target:"_blank",rel:"noopener noreferrer"},m=o(`<h2 id="primeiros-passos" tabindex="-1"><a class="header-anchor" href="#primeiros-passos" aria-hidden="true">#</a> Primeiros passos</h2><p>Configuração SonarQube</p><ol><li>Execute o servidor SonarQube</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -d --name sonarqube -p 9000:9000 sonarqube:7.5-community
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>O projeto Sonarquebe deve estar iniciando.</p>`,5),v={href:"http://localhost:9000",target:"_blank",rel:"noopener noreferrer"},k=o(`<ol start="2"><li>Execute e verifique se um servidor está instalado e executando:</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker ps
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,2),b={start:"3"},g={href:"http://localhost:9000",target:"_blank",rel:"noopener noreferrer"},h={href:"http://localhost:9000/account/security",target:"_blank",rel:"noopener noreferrer"},_=n("li",null,[n("p",null,"Copie o valor do token e salve-o em algum lugar, pois você não poderá vê-lo novamente! Você precisará mais tarde neste tutorial.")],-1),f=n("li",null,[n("p",null,"Crie uma nova pasta para a imagem do Scanner SonarQube dockerfile.")],-1),x=o(`<p>Está pasta será responsável para executar os scanners de código dos projetos que você precisar.</p><p>Execute:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mkdir sonarqube-scanner
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,25),N={href:"http://localhost:9000/projects",target:"_blank",rel:"noopener noreferrer"};function w(R,y){const e=i("ExternalLinkIcon");return r(),l("div",null,[d,n("p",null,[s("Docker - "),n("a",p,[s("https://www.docker.com/get-started"),a(e)])]),n("p",null,[s("Git - "),n("a",u,[s("https://git-scm.com/downloads"),a(e)])]),m,n("p",null,[s("Entre em "),n("a",v,[s("http://localhost:9000"),a(e)]),s(".")]),k,n("ol",b,[n("li",null,[n("p",null,[s("Aguarde o servidor iniciar e efetue login no servidor SonarQube em "),n("a",g,[s("http://localhost:9000"),a(e)]),s(" Utilize credenciais padrão: login: admin password:admin")])]),n("li",null,[n("p",null,[s("Acesse: "),n("a",h,[s("http://localhost:9000/account/security"),a(e)]),s(" e gere um token.")])]),_,f]),x,n("p",null,[s("Após o termino do scanner. Ao entrar em "),n("a",N,[s("http://localhost:9000/projects"),a(e)]),s(" você verá o seu projeto.")])])}const O=t(c,[["render",w],["__file","index.html.vue"]]);export{O as default};
